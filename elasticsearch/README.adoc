...
- ElasticSearch deprecated plugins (ElasticSearch version 2.3.3.x)
  * head, [blue yellow-background line-through]#http://localhost:9200/_plugin/head/#
  * dejaVu, [blue yellow-background line-through]#http://localhost:9200/_plugin/dejaVu/#
  * kopf, [blue yellow-background line-through]#http://localhost:9200/_plugin/kopf/#
