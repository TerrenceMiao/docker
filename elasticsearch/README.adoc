...
- ElasticSearch deprecated plugins (ElasticSearch version 2.3.3.x)
  * head, [blue line-through]*http://localhost:9200/_plugin/head/*
  * dejaVu, [blue line-through]*http://localhost:9200/_plugin/dejaVu/*
  * kopf, [blue line-through]*http://localhost:9200/_plugin/kopf/*
