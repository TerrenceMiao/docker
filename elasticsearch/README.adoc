...
----
terrence@muffler ~/elasticsearch
13:07:32 195 𝜆 docker run -d -v "$PWD/data":/usr/share/elasticsearch/data -v "$PWD/config/elasticsearch.yml":/usr/share/elasticsearch/config/elasticsearch.yml -p 9200:9200 -p 9300:9300 -e "discovery.type=single-node" --name elasticsearch6 docker.elastic.co/elasticsearch/elasticsearch:6.2.4

terrence@igloo ~/elasticsearch
04:16:44 𝜆 cat config/elasticsearch.yml
