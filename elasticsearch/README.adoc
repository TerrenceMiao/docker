...
- ElasticSearch deprecated plugins (ElasticSearch version 2.3.3.x)
  * head, [line-through]#http://localhost:9200/_plugin/head/#
  * dejaVu, , [line-through]#http://localhost:9200/_plugin/dejaVu/#
  * kopf, [line-through]#http://localhost:9200/_plugin/kopf/#
