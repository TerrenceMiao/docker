...
𝜆 docker run --rm -ti -v /Users/terrence/elastic/backup:/tmp taskrabbit/elasticsearch-dump --input=/tmp/postaladdress.json --output=http://10.101.36.117:9200/postaladdress --type=data --limit=100000
----
